            ...
            for( var i=0; i < this.state.Results.length; i++ ){
                ...
                if( 'title' in hl ) {
                  ...
                  li.push(
                      React.createElement("li", {key: r._source.url}, 
                        React.createElement("a", {href: r._source.url}, 
                          React.createElement("h3", {className: "list-group-item-heading", dangerouslySetInnerHTML: {__html: title}})
                        ), 
                  ...
                  li.push(
                      React.createElement("li", {key: r._source.url}, 
                        React.createElement("a", {href: r._source.url}, 
                          React.createElement("h3", {className: "list-group-item-heading"}, title)
                        ), 
                          React.createElement("div", {className: "list-group-item-text"}, body)
                      )
                      );
