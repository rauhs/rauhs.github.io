    ...
    var SearchResults = React.createClass({displayName: "SearchResults",
        ...
        render: function() {
            ...
            for( var i=0; i < this.state.Results.length; i++ ){
                ...
                var body = undefined;
                if( 'body' in hl ) {
                  body = React.createElement("div", {dangerouslySetInnerHTML: {__html: hl.body}});
                }
                if( 'title' in hl ) {
                  li.push( React.createElement("li", null, React.createElement("a", {href: r._source.url, dangerouslySetInnerHTML: {__html: hl.title}}), body) );
                } else {
                  li.push( React.createElement("li", null, React.createElement("a", {href: r._source.url}, r._source.title), body) );
                }
            }
            if( li.length == 0 ) {
              ...
              return (
                React.createElement("div", null, 
                  ...
                  React.createElement("ol", {className: "search-results"}, li)
                )
              );
            }
        }
