...
(function(global,$,React) {
  ...
  function doAjaxSearch(q) {
      var query = '/api/v1/search?q=' + encodeURIComponent(q);
      var p = $.ajax({
          method: "GET",
          url: query,
          dataType: 'json',
