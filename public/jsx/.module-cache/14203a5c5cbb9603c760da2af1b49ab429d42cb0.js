        ...
        return (
          React.createElement("div", null, 
            React.createElement("address", null, 
              React.createElement("strong", null, user.user), React.createElement("br", null), 
              React.createElement("span", null, React.createElement("strong", null, "Email:"), user.email, React.createElement("br", null))
            ), 
            React.createElement("dl", null, 
              React.createElement("dt", null, "Email:"), React.createElement("dt", null
              ), React.createElement("dd", null, "Andre")
            ), 
            React.createElement("dl", null, 
              React.createElement("dt", null, "Additional:"), React.createElement("dt", null
              ), React.createElement("dd", null, 
                React.createElement("span", {className: "label label-success"}, "Staff")
              )
            ), 
            React.createElement("div", {className: "list-group"}, 
              React.createElement("span", {href: "#", className: "list-group-item list-group-item-success"}, "Cras justo odio"), 
              React.createElement("a", {href: "#", className: "list-group-item"}, "Dapibus ac facilisis in"), 
              React.createElement("a", {href: "#", className: "list-group-item"}, "Morbi leo risus"), 
              React.createElement("a", {href: "#", className: "list-group-item"}, "Porta ac consectetur ac"), 
              React.createElement("a", {href: "#", className: "list-group-item"}, "Vestibulum at eros")
            ), 
