(function(window,$,React) {
  ...
  var STAFF_LINKS = {
    ...
    "Nagios": "https://staff.eecis.udel.edu:37222/",
    "Zoneminder": "https://staff.eecis.udel.edu:44388/",
    "Gogs": "https://staff.eecis.udel.edu:32272/",
    "Superuser Gogs": "https://staff.eecis.udel.edu:32273/",
  };
  ...
  var AccountInfo = React.createClass({displayName: "AccountInfo",
      ...
      logout: function(e) {
        ...
        var p = $.ajax({
          url: '/api/v1/logout',
          method: "POST",
          success: this.handleLogoutSuccess.bind(this),
          //error:   this.handleError.bind(this),
        });
      },
      handleLogoutSuccess: function() {
        // Push the new userinfo:
        this.props.userBus.onNext({
          loggedIn: false
        });
      },
      // AVAILABLE:
      ...
      render: function() {
        ...
        if( user.staff ) {
          tags.push([
                ...
                // We need this space in between labels or they'll be stuck together
                " "
          ]);
        }
        tags.push(
        ...
        if( user.staff ) {
          ...
          $.each( STAFF_LINKS,
            function(name, href) {
              li.push(React.createElement("a", {href: href, className: "list-group-item"}, name));
            }
          );
          links = (
  ...
  var AccountDropDownContent = React.createClass({displayName: "AccountDropDownContent",
      ...
      onLoginSuccess: function(userinfo) {
        this.props.userBus.onNext($.extend(userinfo, {loggedIn:true}));
