    ...
    var SearchResults = React.createClass({displayName: "SearchResults",
        ...
        render: function() {
            ...
            if( li.length == 0 ) {
              ...
              //<div className="alert alert-warning">Press <kbd>Enter</kbd>: Go to first result</div>
              return (
                React.createElement("div", null, 
                  React.createElement("span", {className: "label label-info glyphicon glyphicon-info-sign"}, "Press ", React.createElement("kbd", null, "Enter"), ": Go to first result"), 
