                ...
                if( 'title' in hl ) {
                  li.push(
                      React.createElement("a", {href: r._source.url}, 
                        React.createElement("h4", {class: "list-group-item-heading", dangerouslySetInnerHTML: {__html: hl.title}}), 
                        React.createElement("p", {className: "list-group-item-text"}, body)
                      ) );
                } else {
                  li.push( React.createElement("a", {href: r._source.url}, 
                        React.createElement("h4", {class: "list-group-item-heading"}, r._source.title), 
                        React.createElement("p", {className: "list-group-item-text"}, body)
                      ) );
                }
            }
