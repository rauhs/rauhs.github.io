    ...
    var SearchResults = React.createClass({displayName: "SearchResults",
        ...
        render: function() {
            ...
            for( var i=0; i < this.state.Results.length; i++ ){
                ...
                if( 'title' in hl ) {
                  var title = hl.title[0].replace(/\u00B7.*ECE\/CIS\s*$/,"");
                  li.push(
                      React.createElement("a", {href: r._source.url}, 
                        React.createElement("h3", {class: "list-group-item-heading", dangerouslySetInnerHTML: {__html: title}}), 
                        React.createElement("div", {className: "list-group-item-text"}, body)
                      ) );
                } else {
                  window._title = r._source.title;
                  var title = r._source.title.replace(/\u00B7.*ECE\/CIS\s*$/,"");
                  li.push( React.createElement("a", {href: r._source.url}, 
                        React.createElement("h3", {class: "list-group-item-heading"}, title), 
                        React.createElement("div", {className: "list-group-item-text"}, body)
                      ) );
                }
            }
            if( li.length == 0 ) {
              ...
              return (
                React.createElement("div", null, 
                  "//", React.createElement("div", {className: "alert alert-warning"}, "Press ", React.createElement("kbd", null, "Enter"), ": Go to first result"), 
                  React.createElement("span", {className: "label label-info"}, "Press ", React.createElement("kbd", null, "Enter"), ": Go to first result"), 
